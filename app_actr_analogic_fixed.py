...
# Parámetros globales
F = 0.5
UMBRAL_RECUPERACION = 1.0  # Más flexible
...
def crear_memoria_iso():
    ...
    chunks_data = [
        ...
        ("Liderazgo", "Los líderes establecen dirección y fomentan una cultura de compromiso.",
         ...
         {"capitán": 0.85, "dirección": 0.6, "lider": 0.75, "guía": 0.65, "equipo": 0.6}),
...
# Guardar en sesión la selección
...
if st.button("🚀 Iniciar Simulación"):
    ...
    st.session_state.chunk = chunk  # Guardar resultado

if st.session_state.chunk:
